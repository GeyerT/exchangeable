...
var runningAPIClient = undefined
...
client.on('connect', async function(connection) {
    ...
    app = new APIClient(connection)
    app.startListeners(connection)
      ...
      if (message.type === "utf8") {
          ...
          switch (clientMessage.type) {
              case "brain-to-service-connection-opened":
                  console.log("api connected: ", clientMessage.content.success)
                  break;

              case "brain-to-api-answer-request":
                  app.answerRequest(clientMessage.content.status, clientMessage.content.reqId, clientMessage.content.data)
                  break;
          }
      }
    });
